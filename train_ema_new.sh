...
$PYTHON_BIN /nfsdat1/home/rfchenslm/centurymaze/src/mazebots_ema_new/session.py \
  --ctrl_mode 2 \
  --headless 1 \
  --model_name codebook384 \
  --n_envs 9 \
  --n_bots 112 \
  --use_vq_comm 1 \
  --vq_weight 0.03 \
  --vq_commitment_cost 0.8 \
  --vq_num_embeddings 384 \
  --vq_ema_decay_start 0.98 \
  --vq_ema_decay_end 0.99 \
  --vq_refresh_enabled 1 \
  --vq_refresh_steps 2 \
  --vq_refresh_start_size 5000 \
  --vq_refresh_batch_size 1024
echo "===== TRAIN DONE ====="
date