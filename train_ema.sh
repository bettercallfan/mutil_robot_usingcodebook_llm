#!/bin/bash
#SBATCH -J ema_commitment0.03_1024kmeans_w0.005
#SBATCH -p gpu
...
$PYTHON_BIN /nfsdat1/home/rfchenslm/centurymaze/src/mazebots_ema/session.py \
  --ctrl_mode 2 \
  --headless 1  \
  --model_name ema1_commitment0.03_4096kmeans_w0.005 \
  --n_envs 9 \
  --n_bots 112 \
  --use_vq_comm 1 \
  --vq_weight 0.005 \
  --vq_commitment_cost 0.03 \
  --vq_num_embeddings 1024 \
  --vq_codebook_init_path /nfsdat1/home/rfchenslm/centurymaze/data/your_codebook.npz
echo "===== TRAIN DONE ====="
date